@php
    ...
    $footerGroups = [
        ...
        [
            ...
            'links' => [
                ...
                ['label' => 'Chính sách thanh toán', 'url' => home_url('/chinh-sach-bao-mat-thong-tin-thanh-toan/')],
                [
                    'label' => 'Chính sách và quy trình giải quyết tranh chấp – khiếu nại',
                    'url' => home_url('/chinh-sach-va-quy-trinh-giai-quyet-tranh-chap-khieu-nai/'),
                ],
                [
                    'label' => 'Quy chế hoạt động',
                    'url' => home_url('/quy-che-hoat-dong-dailyve/'),
                ],
            ],
        ],
    ];
    ...
    $contactItems = [
        ...
        [
            'label' => 'support@dailyve.com',
            'meta' => 'Email hỗ trợ',
            'icon' => 'far fa-envelope',
            'url' => 'mailto:support@dailyve.com',
        ],
        [
            'label' => 'Phục vụ khách hàng 24/7',
            'meta' => 'Kể cả ngày lễ & Tết',
            'icon' => 'far fa-clock',
            'url' => null,
        ],
    ];
...
<footer class="bg-[#041224] text-white border-t border-white/5">
    <div class="dailyve-container pt-12 pb-6 md:pt-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 mb-12">
            ...
            <div class="lg:col-span-4 flex flex-col gap-6 lg:border-r lg:border-white/10 lg:pr-10">
                ...
                <div class="grid gap-4 mt-2">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-full border border-[#1677ff]/30 bg-[#06152c] flex items-center justify-center shrink-0">
                ...
                <div class="flex items-center gap-3 pt-2">
                    @foreach ($socialLinks as $social)
                        <a href="{{ esc_url($social['url']) }}" aria-label="{{ esc_attr($social['label']) }}"
            ...
            <div class="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
                @foreach ($footerGroups as $group)
                    <div>
                        <h3
                            class="text-[14px] font-bold text-white m-0 pb-3 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-6 after:h-[2px] after:bg-[#3b82f6]">
                            {{ $group['label'] }}</h3>
        ...
        <div
            class="py-8 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-8 xl:gap-4 border-t border-white/10">
            <div class="flex flex-col md:flex-row gap-6 md:gap-8 w-full xl:w-auto">
                <div class="flex items-center gap-4">
                    <div
                        class="w-10 h-10 rounded-xl bg-[#06152c] border border-white/10 flex items-center justify-center shrink-0">
                        <i class="fas fa-phone-alt text-[#3b82f6] text-sm" aria-hidden="true"></i>
                    </div>
                    <div>
                        <a href="tel:19005155"
                            class="text-[14px] font-bold text-white hover:text-[#3b82f6] m-0 no-underline block">1900
                            5155</a>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <a href="mailto:support@dailyve.com"
                            class="text-[14px] font-bold text-white hover:text-[#3b82f6] m-0 no-underline block">support@dailyve.com</a>
            ...
            <div
                class="flex flex-col sm:flex-row xl:flex-row items-center gap-4 shrink-0 xl:border-l xl:border-white/10 xl:pl-8 w-full sm:w-auto">
                ...
                <div class="flex items-center gap-3">
                    <a href="https://apps.apple.com/vn/app/dailyve-%C4%91%E1%BA%B7t-v%C3%A9-xe-24-7/id6748101538"
                        ...
                        class="hover:opacity-90 transition-opacity block rounded-lg overflow-hidden border border-white/20 bg-[#06152c]">
                        <img src="{{ esc_url($appStore) }}" alt="App Store" class="w-[125px] h-[38px] object-cover">
                    </a>
                    <a href="https://play.google.com/store/apps/details?id=com.dailyve" aria-label="Google Play"
                        class="hover:opacity-90 transition-opacity block rounded-lg overflow-hidden border border-white/20 bg-[#06152c]">
        ...
        <div class="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                ...
                <a href="http://online.gov.vn/Home/WebDetails/127508" target="_blank" rel="nofollow"
                    aria-label="Bộ Công Thương" class="inline-block hover:opacity-80 transition-opacity">
                    <img src="https://dailyve.com.vn/wp-content/uploads/2025/01/BCT-LOGO.png"
                        alt="Đã thông báo Bộ Công Thương" class="h-9 w-auto object-contain">
                </a>
            </div>
            ...
            <div class="flex items-center gap-3 flex-wrap justify-center">
                ...
                <span
                    class="inline-flex items-center justify-center h-[26px] px-3 rounded text-white text-[11px] font-bold tracking-wide bg-[#1a1f71]">VISA</span>
                <span
                    class="inline-flex items-center justify-center h-[26px] px-3 rounded text-white text-[11px] font-bold tracking-wide"
                    style="background: linear-gradient(90deg, #eb001b 0%, #f79e1b 100%);">Mastercard</span>
                <span
                    class="inline-flex items-center justify-center h-[26px] px-3 rounded text-white text-[11px] font-bold tracking-wide bg-[#a50064]">MoMo</span>
                <span
                    class="inline-flex items-center justify-center h-[26px] px-3 rounded text-white text-[11px] font-bold tracking-wide bg-[#0068ff]">ZaloPay</span>
            </div>
        </div>
