...
@section('content')
    <div class="dailyve-bus-page bg-slate-50 min-h-screen font-sans antialiased text-slate-800 pb-20">
        ...
        {{-- Breadcrumbs --}}
        <x-breadcrumb :items="[['title' => 'Trang chủ', 'url' => home_url('/')], ['title' => 'Vé máy bay', 'url' => '']]" preset="default" />
        ...
        <div class="dailyve-bus-search-section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
            <div class="dailyve-bus-search-card relative overflow-visible">
                ...
                <div id="react-search-form" class="min-h-[120px]" data-initial-service="flight">
                ...
                <div class="lg:col-span-7 flex flex-col justify-between">
                    <div>
                        ...
                        <p class="text-slate-600 leading-relaxed mb-8 text-sm md:text-base">
                            ...
                            là đối tác tin cậy của hơn 100 hãng hàng không uy tín cung cấp đa dạng dòng xe đáp ứng nhu cầu
                            đi lại của
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div
                            ...
                            <div>
                                <h4 class="font-bold text-slate-900 mb-1 text-sm md:text-base">Hãng hàng không uy tín cao
                                </h4>
