    ...
    <div class="route-directory overflow-x-hidden bg-slate-50 text-slate-700">
        ...
        <header class="bg-white">
            <div class="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:px-8 lg:py-14">
                ...
                <aside class="rounded-xl border border-slate-200 bg-slate-50 p-5" aria-label="Thông tin danh sách nhà xe">
                    <div class="grid grid-cols-2 gap-3">
                        <div class="rounded-lg bg-white p-4">
                            <span class="block text-sm font-medium text-slate-500">Hãng xe đang có</span>
                            <strong
            ...
            <section aria-labelledby="route-directory-list-title" class="mx-auto max-w-7xl">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-500">
                            @if ($total_routes > 0)
                                ...
                                trong {{ number_format($total_routes, 0, ',', '.') }} nhà xe.
                            @else
                                Dailyve đang cập nhật thêm nhà xe mới.
                            @endif
                        </p>
                    </div>
                        ...
                        @while ($routes_query->have_posts())
                            ...
                            <article
                                ...
                                <a href="{{ esc_url($route_url) }}"
                                    ...
                                    @else
                                        <div
                                            class="image-placeholder flex h-full w-full items-center justify-center text-4xl text-slate-300">
                                            <i class="fas fa-bus" aria-hidden="true"></i>
                                        </div>
                                    @endif
                                </a>
                ...
                @else
                    ...
                    <div class="rounded-xl border border-dashed border-slate-300 bg-white p-8 text-center">
                        <h3 class="text-lg font-semibold text-slate-950">Chưa có nhà xe</h3>
                        <p class="mt-2 text-sm text-slate-500">Dailyve đang cập nhật thêm các nhà xe khách mới.</p>
                    </div>
                @endif
            </section>
        </main>
