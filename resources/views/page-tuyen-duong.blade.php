    ...
    <div class="route-directory overflow-x-hidden bg-slate-50 text-slate-700">
        ...
        <nav class="border-b border-slate-200 bg-white" aria-label="Breadcrumb">
            <ol
                ...
                <li><a class="text-slate-500 hover:text-blue-600" href="{{ esc_url(home_url('/ve-xe-khach/')) }}">Vé xe
                        khách</a></li>
                <li aria-hidden="true">/</li>
                <li class="font-semibold text-slate-900" aria-current="page">Tuyến đường</li>
            </ol>
        </nav>
