...
<div class="min-h-screen bg-slate-50/50 pb-20 pt-10">
    <div class="mx-auto max-w-7xl px-4">
        ...
        @if (!empty($tickets))
            <div class="mb-10">
                <h1 class="font-display text-4xl font-black tracking-tight text-slate-900">Xác nhận <span class="text-primary">đặt vé</span></h1>
                ...
                <div class="space-y-8">
                    <section class="rounded-[2.5rem] bg-white p-8 shadow-premium md:p-12">
                        ...
                        <div class="mt-10 grid gap-8 md:grid-cols-2">
                            <div class="space-y-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400">Họ và tên *</label>
                                <input 
                                    type="text" 
                                    name="customer-name"
                            ...
                            <div class="space-y-2 md:col-span-2">
                                <label class="text-xs font-black uppercase tracking-widest text-slate-400">Ghi chú</label>
                                <textarea 
                                    name="customer-note"
                                    rows="3"
                    ...
                    <div class="hidden lg:block">
                        <button id="btn_payment_desktop" class="group flex w-full items-center justify-center gap-4 rounded-[2rem] bg-success py-6 text-xl font-black text-white shadow-xl shadow-success/20 transition-all hover:scale-[1.02] hover:opacity-95 active:scale-95">
                            TIẾP TỤC THANH TOÁN
                    ...
                    <div class="sticky top-24 space-y-6">
                        <section class="overflow-hidden rounded-[2.5rem] bg-white shadow-premium">
                            <div class="bg-slate-50/80 px-8 py-6">
                                <h3 class="font-display text-lg font-black text-slate-900">Chi tiết chuyến đi</h3>
                            </div>
                                ...
                                @foreach ($tickets as $key => $ticket)
                                    <div class="relative space-y-6">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="font-display text-lg font-black text-slate-900">{{ $ticket['seatsAndInfoData']['company_name'] ?? 'Nhà xe' }}</div>
                                        ...
                                        <div class="space-y-6 border-l-2 border-dashed border-slate-100 pl-8">
                                            <div class="relative">
                                                ...
                                                <div class="font-display text-xl font-black text-slate-900">
                                        ...
                                        <div class="flex items-center gap-3 rounded-2xl bg-slate-50 p-4">
                                            ...
                                            <div>
                                                <div class="text-[10px] font-black uppercase tracking-widest text-slate-400">Số ghế đã chọn</div>
                        ...
                        <div class="lg:hidden">
                            <button id="btn_payment_mobile" class="flex w-full items-center justify-center gap-4 rounded-3xl bg-success py-5 text-lg font-black text-white shadow-xl shadow-success/20">
                                TIẾP TỤC THANH TOÁN
        ...
        @else
            <div class="flex flex-col items-center justify-center rounded-[3rem] border-2 border-dashed border-slate-200 bg-white py-32 text-center shadow-sm">
                ...
                <h2 class="font-display text-3xl font-black text-slate-900">Giỏ hàng trống</h2>
                ...
                <a href="/" class="mt-10 rounded-2xl bg-primary px-10 py-4 text-sm font-black text-white shadow-lg shadow-primary/20 transition-all hover:opacity-90 active:scale-95">
                    QUAY LẠI TRANG CHỦ
                </a>
            </div>
        @endif
        ...
        btnPayment.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                const departure_dates = tickets.map(t => {
                    const date = t.seatsAndInfoData.departure_date || '';
                    const time = t.seatsAndInfoData.departure_time || '';
                    return time + ' ' + date;
                });
