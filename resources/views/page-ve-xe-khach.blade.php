...
@section('content')
    <div class="dailyve-bus-page bg-slate-50 min-h-screen font-sans antialiased text-slate-800 pb-20">
        ...
        {{-- Breadcrumbs --}}
        <x-breadcrumb :items="[['title' => 'Trang chủ', 'url' => home_url('/')], ['title' => 'Vé xe khách', 'url' => '']]" preset="default" />
        ...
        <div class="dailyve-bus-search-section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
            <div class="dailyve-bus-search-card relative overflow-visible">
                ...
                <div id="react-search-form" class="min-h-[120px]" data-initial-service="bus">
        ...
        @php
            $bus_offers = array_slice(\App\dailyve_get_mock_coupons(), 0, 6);
        @endphp
